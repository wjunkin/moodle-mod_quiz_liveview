...
/**
 * Strings for component 'quiz_liveresults', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   quiz_liveresults
...
$string['liveresults'] = 'Grades';
$string['liveresultsdownload'] = 'Live results download';
$string['liveresultsfilename'] = 'grades';
$string['liveresultsreport'] = 'Grades report';
$string['liveresultsreportgraph'] = 'Overall number of students achieving grade ranges';
$string['liveresultsreportgraphgroup'] = 'Number of students in group \'{$a}\' achieving grade ranges';
